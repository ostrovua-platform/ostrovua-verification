...
Без змін (roadmap, погоджено): P0-01 (typed assurance boundary),
P0-02 (синхронізація depth/RGB, ROI-mapping, challenge, PAD-корпус),
P0-03 (біометрична валідація), P0-04/05 (повна відтворюваність),
P1-05 (purpose-binding челенджів), P1-07, P1-09, P1-10 (CA/AA),
P1-11, P1-12, P1-13, P1-14, P1-15, P1-16, P2-01…P2-04, P2-07.
